...
def setup():
    ...
    glMaterialfv(GL_FRONT_AND_BACK, GL_AMBIENT_AND_DIFFUSE,
                 vec(hextoint(30), hextoint(30), hextoint(30), hextoint(255)))
...
class Circle(object):
    def __init__(self, posx=0, posy=0, radius=1, sides=35):
        ...
        for i in range(sides):
            ...
            glVertex2f(x, y)
        # math : P=pr^2=p*r*r= p*r*2 programming i*2*pi/sides together : i =
        #  p i*2, *2=r^2 this should help you
        glEnd()
        glEndList()
...
class vertex():
    def __init__(self):
        self.obj = pyglet.graphics.vertex_list(2, ('v2i', (10, 15, 30, 35)),
                                               ('c3B', (0, 0, 255, 0, 255, 0)))


class gui(pyglet.window.Window):
    def __init__(self, width=1200, height=900):
        super(gui, self).__init__(650, 450, vsync=True, fullscreen=False,
                                  resizable=True,
        ...
        hextoint(0), hextoint(0), hextoint(0), hextoint(255))}
        ...
        self.fr = pyglet.text.Label(text='calculating fps',
                                    font_name='Verdana', font_size=8,
